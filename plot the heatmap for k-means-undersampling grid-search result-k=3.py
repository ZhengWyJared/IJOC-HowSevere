...
import ast
file_path = '.../K=3-Kmeans-undersampling-gridsearch/final_results_weightrecall.xlsx'
...
for index, row in df.iterrows():
    ...
    first_two = quantiles[:3]
    last_two = quantiles[-3:]
...
heatmap_data['Dimension1'] = heatmap_data['Dimension1'].round(6)
heatmap_data['Dimension2'] = heatmap_data['Dimension2'].round(6)
...
plt.xlabel('Average of the three quantiles-label 2', fontsize=22)
plt.ylabel('Average of the three quantiles-label 1', fontsize=22)
