...
# Set the grid
quantiles = {
    (1, 0): [0.14, 0.18, 0.22, 0.26, 0.30, 0.34, 0.38, 0.42],  # Label 1, Cluster 0
    (1, 1): [0.14, 0.18, 0.22, 0.26, 0.30, 0.34, 0.38, 0.42],  # Label 1, Cluster 1
    (2, 0): [0.40, 0.44, 0.48, 0.52, 0.56, 0.60],              # Label 2, Cluster 0
    (2, 1): [0.40, 0.44, 0.48, 0.52, 0.56, 0.60]               # Label 2, Cluster 1
}
quantile_combinations = list(itertools.product(
    quantiles[(1, 0)], quantiles[(1, 1)], quantiles[(2, 0)], quantiles[(2, 1)]
))

results_dir = '..../K=2-Kmeans-undersampling-gridsearch'
...
kmeans_label1 = KMeans(n_clusters=2, n_init=1000, random_state=random_seed, init='k-means++')
...
kmeans_label2 = KMeans(n_clusters=2, n_init=1000, random_state=random_seed, init='k-means++')
...
def train_with_quantile_combination(quantile_combination):
    quantiles_dict = {
        ...
        (2, 0): quantile_combination[2],
        (2, 1): quantile_combination[3]
    }
